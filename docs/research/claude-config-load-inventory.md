...
| `rules/hooks-reference.md` | `path_glob_match` | 6387 | no | **no** | Loads only when a matching file is read; summarized away by compaction. |
...
| On-demand path-scoped rules | 31 | 142852 |
...
| `prd-next` | 13468 | 4810 | 5611 | at risk — over on the dense estimate | yes | 96 |
...
| Skills over the 5,000-token truncation cap | 8 |

## Always-loaded budget

| Component | Bytes |
|---|---:|
| `global/CLAUDE.md` | 16137 |
| `@`-referenced rules | 54959 |
| Skill descriptions | 3114 |
| **Total always-loaded** | **74210** |
