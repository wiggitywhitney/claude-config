#!/usr/bin/env bash
# ABOUTME: Shared library — detects which test tiers (unit, integration, e2e) exist in a project
# ABOUTME: Used by test-tiers.sh pre-push check; outputs JSON with project_type and test_tier booleans
