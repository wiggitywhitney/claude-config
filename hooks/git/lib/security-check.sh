#!/usr/bin/env bash
# ABOUTME: Shared lib for git hooks — runs security checks (debug code, secrets, npm audit)
# ABOUTME: Standard mode for pushes; pre-pr mode adds npm audit and secret scanning
