#!/usr/bin/env bash
# ABOUTME: Shared lib for git hooks — runs a single verification phase and reports pass/fail
# ABOUTME: Used by pre-commit-verify.sh and pre-push-verify.sh to execute build/typecheck/lint/test
