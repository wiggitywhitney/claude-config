...
- Every cloned Michael candidate has gone through the triage pass — README and top-level structure skimmed on a fast/cheap model, dead ends discarded with a one-line reason recorded — and Whitney has confirmed the survivor list
